...
public class weight_gain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (user.equals("0")){
                    Toast.makeText(weight_gain.this, "Select your Gender", Toast.LENGTH_SHORT).show();
                }
    ...
    private void calculate(){
        ...
        if (user.equals("Male")){
            gain=((10*w)+(6.25*h)-(5*a)+5);
            result.setText(Double.toString(gain+700));
        }
        if (user.equals("Female")){
            gain=((10*w)+(6.25*h)-(5*a)-161);
            result.setText(Double.toString(gain+700));
        }
