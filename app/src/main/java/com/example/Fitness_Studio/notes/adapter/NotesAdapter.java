package com.example.Fitness_Studio.notes.adapter;
...
public class NotesAdapter extends RecyclerView.Adapter<NotesAdapter.NoteViewHolder> {
    ...
    public NoteViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new NoteViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.activity_item_container_note,parent,false));
    }
    ...
    static class  NoteViewHolder extends RecyclerView.ViewHolder{
       ...
       NoteViewHolder(@NonNull View itemView){
           ...
           imageNotes = itemView.findViewById(R.id.imageNotes);
...
//           } else {
//               gradientDrawable.setColor(Color.parseColor("#FFCE3C"));
//           }
           if (note.getImagePath() != null){
               imageNotes.setImageBitmap(BitmapFactory.decodeFile(note.getImagePath()));
